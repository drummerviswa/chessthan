 ...
 */
function generateHeuristicExplanation(fenBefore, fenAfter, move, bestMove) {
    try {
 ...
 */
export async function explainMove(fenBefore, fenAfter, move, bestMove) {
    if (!genAI) {
 ...
 */
export async function generateGameReview(pgn) {
