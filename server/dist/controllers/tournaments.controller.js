...
export const createTournamentEndpoint = (req, res) => {
    ...
    try {
        const tournament = manager.createTournament(name, type, timeControl, Number(roundsOrDuration));
...
export const joinTournamentEndpoint = (req, res) => {
    const { id } = req.params;
...
export const startTournamentEndpoint = (req, res) => {
    const { id } = req.params;
    try {
...
export const getTournamentStatusEndpoint = (req, res) => {
    const { id } = req.params;
